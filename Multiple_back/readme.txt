 ...
 vcftools --vcf  *.vcf --max-alleles 2 --min-alleles 2 --out biallele --recode

../GHIST-2025_multiple/selscan-main/bin/macos-arm64/selscan --nsl --vcf biallele.recode.vcf  --out testing --keep-low-freq 
